...
def get_object_from_key(
    ...
    if time_elapsed.total_seconds() > confirmation.validity_in_days * 24 * 3600:
...
def create_confirmation_link(
    ...
    if not validity_in_days:
        validity_in_days = _properties[confirmation_type].validity_in_days
...
class Confirmation(models.Model):
    ...
    validity_in_days: int = models.PositiveIntegerField(
        default=settings.CONFIRMATION_LINK_DEFAULT_VALIDITY_DAYS
    )
